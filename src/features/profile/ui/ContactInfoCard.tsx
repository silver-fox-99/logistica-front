  ...
  const schema = z.object({
    ...
    email: z
      ...
      .refine(
        ...
        t("profile.validation.invalidEmail"),
      ),
      ...
      <form onSubmit={handleSubmit(submit)} noValidate>
        <Stack spacing={3}>
          <Box>
            ...
            >
              {t(
                "profile.contactInfo.description",
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                ...
                <Box>
                  <Typography
                    variant="subtitle2"
                    sx={{ mb: 0.8, fontWeight: 600, color: "#0c2340" }}
                  >
                    Имя
                  </Typography>
                  <TextField
            ...
            >
              ...
              <Stack spacing={0.5}>
                ...
                <Typography variant="caption" color="text.secondary">
                  Публичный профиль позволяет другим пользователям находить вас
                  на платформе и видеть информацию о вас
                </Typography>
              </Stack>
            </Box>
