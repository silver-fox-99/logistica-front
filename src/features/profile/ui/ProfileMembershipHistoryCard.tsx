...
export default function ProfileMembershipHistoryCard({
  items,
  loading,
}: Props) {
    ...
    >
      <Stack spacing={2}>
        ...
        {loading && (
          <Typography variant="body2" color="text.secondary">
            {t(
              "profile.membershipHistory.loading",
                      ...
                      <Stack spacing={0.35} sx={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          ...
                          >
                            {item.company?.name ||
                              t(
                                "profile.membershipHistory.unknownCompany",
                                "Unknown company",
                              )}
                          </Typography>
                          ...
                          {item.is_default && (
                            <Chip
                              ...
                              color="primary"
                              label={t(
                                "profile.membershipHistory.default",
                                "Default",
                              )}
                            />
                          )}
                    ...
                    >
                      {item.joined_at && (
                        <MetaRow
                          ...
                          label={t(
                            "profile.membershipHistory.joinedAt",
                            "Joined",
                          )}
                      ...
                      {item.removed_at && (
                        <MetaRow
                          ...
                          label={t(
                            "profile.membershipHistory.removedAt",
                            "Left",
                          )}
                      ...
                      {item.invited_by_user && (
                        <MetaRow
                          ...
                          label={t(
                            "profile.membershipHistory.invitedBy",
                            "Invited by",
                          )}
                          value={invitedBy}
                        />
                      ...
                      {item.invited_at && (
                        <MetaRow
                          ...
                          label={t(
                            "profile.membershipHistory.invitedAt",
                            "Invited",
                          )}
