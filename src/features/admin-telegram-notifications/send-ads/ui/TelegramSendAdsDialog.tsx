    ...
    >
      ...
      <DialogContent dividers sx={{ p: 2 }}>
        ...
        >
          ...
          <Stack spacing={2.5} sx={{ flex: 1, minWidth: 0 }}>
                        ...
                        label={
                          ...
                          >
                            ...
                            >
                              ...
                              {c.chat_ids.length === 1
                                ? "канал"
                                : c.chat_ids.length > 1 && c.chat_ids.length < 5
                                  ? "канала"
                                  : "каналов"}
                              )
                            </Typography>
                ...
                >
                  ...
                  <Tooltip title="Спойлер (скрытый)">
                    <IconButton
                      size="small"
                      onClick={() =>
                        handleFormat('<span class="tg-spoiler">', "</span>")
                      }
                    >
                      <FaEyeSlash size={13} />
                    </IconButton>
            ...
            >
              <Typography variant="caption" component="div">
                <b>Доступное форматирование:</b> Telegram поддерживает теги
                HTML. Вы можете использовать панель инструментов для быстрого
                оборачивания выделенного текста.
              </Typography>
            </Alert>
          </Stack>
          ...
          <Stack
            spacing={1}
            sx={{ width: { md: 280, xs: "100%" }, minWidth: 0 }}
          >
            <Typography
              variant="subtitle2"
              fontWeight={600}
              ...
              >
                ...
                >
                  {htmlText.trim() ? (
                    ...
                    <Typography
                      variant="body2"
                      sx={{ fontStyle: "italic", color: "rgba(0,0,0,0.45)" }}
                    >
      ...
      >
        <Box>
          {selectedBotIds.length > 0 && (
            <Typography variant="body2" fontWeight={600} color="success.main">
              Будет отправлено: {selectedBotIds.length} бот
              {selectedBotIds.length === 1 ? "у" : "ам"} (всего в{" "}
              {totalChannelsTargeted} канал
              {totalChannelsTargeted === 1
                ? "ов"
                : totalChannelsTargeted > 1 && totalChannelsTargeted < 5
                  ? "ала"
                  : "алов"}
              )
            </Typography>
        ...
        <Stack direction="row" spacing={1.5}>
          ...
          <Button
            ...
            disabled={
              submitting || selectedBotIds.length === 0 || !htmlText.trim()
            }
            startIcon={
              submitting ? (
