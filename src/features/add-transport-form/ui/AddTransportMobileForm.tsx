      ...
      {index !== 0 && (
        <Box
          sx={{
            ...
            transform: isSectionOpen(index) ? "rotate(180deg)" : "rotate(0deg)",
          }}
        >
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12 }}>
                <TextField
                  ...
                  fullWidth
                  placeholder={t(
                    "addTransport.fields.vehiclesCountPlaceholder",
                  )}
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <LookupAutocomplete
                      ...
                      errorText={
                        (fieldState.error?.message as any) ?? undefined
                      }
                    />
                  )}
                />
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12 }}>
                <TextField
                  ...
                  placeholder={t(
                    "addTransport.fields.additionalInfoPlaceholder",
                  )}
                  fullWidth
                  multiline
                  minRows={3}
