...
import type {
  Place,
  ReviewGeoLoadingState,
} from "@/features/user-reviews-page/model/types.ts";
              ...
              <Stack spacing={1.25}>
                ...
                <Autocomplete
                  ...
                  getOptionLabel={(option) =>
                    getLocalizedGeoName(option) || option.name || ""
                  }
                  ...
                  onChange={(_, value) =>
                    onSelectLoadCountry(value?.id ?? null)
                  }
                ...
                <Autocomplete
                  ...
                  loading={
                    loading.citiesFor ===
                    `${loadPlace.countryId ?? ""}/${loadPlace.regionId ?? ""}`
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
            ...
            >
              <Stack spacing={1.25}>
                ...
                <Autocomplete
                  ...
                  onChange={(_, value) =>
                    onSelectUnloadCountry(value?.id ?? null)
                  }
                  loading={loading.countries}
                  noOptionsText={
                    loading.countries
                ...
                <Autocomplete
                  ...
                  onChange={(_, value) =>
                    onSelectUnloadRegion(value?.id ?? null)
                  }
                ...
                <Autocomplete
                  ...
                  loading={
                    loading.citiesFor ===
                    `${unloadPlace.countryId ?? ""}/${unloadPlace.regionId ?? ""}`
                  }
                  renderInput={(params) => (
                    <TextField
                      {...params}
