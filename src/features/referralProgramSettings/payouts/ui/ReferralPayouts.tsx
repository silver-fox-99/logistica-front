...
export default function ReferralPayouts() {
  ...
  const candidatesTotalFmt = useMemo(
    () => formatIntWithDots(candidatesTotal),
    [candidatesTotal],
  );
      ...
      <Stack spacing={2}>
        ...
        >
          ...
          <Stack direction="row" gap={1}>
            <Button
              variant="outlined"
              startIcon={
                payoutLoading ? <CircularProgress size={16} /> : <FiRefreshCw />
              }
        ...
        <Stack direction={{ xs: "column", md: "row" }} spacing={2}>
          ...
          <TextField
            ...
            onChange={(e) =>
              setMinBalanceCents(Math.max(1, parseIntDots(e.target.value, 1)))
            }
