            ...
            <Box sx={{ width: { xs: 320, sm: 430 }, p: 2 }}>
                <Stack spacing={2}>
                    ...
                    <RHFLookupAutocomplete<TenderFiltersValue>
                        ...
                        placeholder={t("tenders.create.selectCargoType", "Select cargo type")}
                        options={cargoOpts}
                    ...
                    <RHFLookupAutocomplete<TenderFiltersValue>
                        ...
                        placeholder={t("tenders.create.selectVehicleType", "Select vehicle type")}
                        options={vehicleOpts}
                        getOptionLabel={getLocalizedLabel}
                    />
                    ...
                    <RHFLookupAutocomplete<TenderFiltersValue>
                        ...
                        placeholder={t("tenders.create.selectLoadingType", "Select loading type")}
