...
export const DeleteIntegrationTokenDialog = React.memo(
  function DeleteIntegrationTokenDialog({
    open,
    item,
    loading,
    onClose,
      ...
      <Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
        ...
        <DialogContent>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            После удаления внешняя система больше не сможет использовать этот
