...
export default function GeoImportDialog({
    ...
    return (
        <Dialog open={open} onClose={submitting ? undefined : onClose} maxWidth="sm" fullWidth PaperProps={{ sx: { borderRadius: 3 } }}>
            <DialogTitle sx={{ fontWeight: 700 }}>Догрузить гео-данные</DialogTitle>
            <DialogContent dividers>
                <Stack spacing={2.5} mt={1}>
                    <Alert severity="info" sx={{ borderRadius: 2 }}>
                        Выберите, что нужно загрузить из внешнего датасета
                        (страны/регионы/города). Бэкенд по коду страны/региона
                        автоматически подтянет данные и создаст записи в базе данных.
                        Поле <b>Родительская локация</b> позволяет
                        привязать импортируемые записи к уже существующей стране или региону в вашей системе.
                    </Alert>
