...
import { FiDatabase, FiRefreshCw, FiLoader, FiCheckCircle, FiAlertCircle } from "react-icons/fi";
                ...
                <Stack spacing={1.25}>
                    <Stack direction="row" alignItems="center" justifyContent="space-between">
                        <Stack direction="row" spacing={1} alignItems="center">
                            <FiDatabase />
                            <Typography fontWeight={700}>CRM интеграция</Typography>
                        </Stack>
                        {statusChip}
                    </Stack>
                    ...
                    <Stack direction="row" justifyContent="flex-end">
                        ...
                        >
                            {busy ? "Синхронизация…" : syncedAt ? "Повторить попытку" : "Синхронизировать с CRM"}
                        </Button>
                    </Stack>
                </Stack>
            </CardContent>
