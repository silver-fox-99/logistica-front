...
export function CustomTable<T>(props: Props<T>) {
    ...
    useEffect(() => {
        ...
        const t = window.setTimeout(() => onSearchChange(localSearch), searchDebounceMs);
    ...
    const [colWidths, setColWidths] = useState<Record<string, number>>(() => {
        if (!tableId) return {};
        const saved = safeParseJson<Record<string, number>>(localStorage.getItem(storageKey(tableId)));
        return saved ?? {};
    });
                                    ...
                                    return (
                                        <TableCell
                                            ...
                                            sx={{
                                                ...
                                                ...(typeof c.minWidth === "number" ? { minWidth: `${c.minWidth}px` } : null),
                                                ...(typeof c.maxWidth === "number" ? { maxWidth: `${c.maxWidth}px` } : null),
