        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell sx={{ width: 140 }}>
              {t("paymentsNew.table.amount", "Amount")}
            </TableCell>
            <TableCell sx={{ width: 140 }}>
              {t("paymentsNew.table.status", "Status")}
            </TableCell>
            <TableCell sx={{ width: 140 }}>
              {t("paymentsNew.table.provider", "Provider")}
            </TableCell>
            <TableCell sx={{ width: 180 }}>
              {t("paymentsNew.table.created", "Created")}
            </TableCell>
            <TableCell sx={{ width: 80 }}>
              {t("paymentsNew.table.link", "Link")}
            </TableCell>
          </TableRow>
        </TableHead>
                ...
                <TableRow key={inv.id}>
                  ...
                  <TableCell>
                    {inv.short_link || inv.checkout_url ? (
                      <Tooltip
                        title={t("paymentsNew.table.openLink", "Open link")}
                      >
                        <IconButton
                          size="small"
                          component="a"
