...
export function ShipmentDetailsSpecs({ data, kind }: Props) {
    ...
    const cargoRows = [
        data.vehicleType ? [t("shipments.shipmentCard.vehicleType", "Vehicle type"), data.vehicleType] : null,
        data.cargoType ? [t("shipments.shipmentCard.cargoType", "Cargo type"), data.cargoType] : null,
        data.loadType?.length ? [t("shipments.shipmentCard.loadType", "Load type"), data.loadType.join(", ")] : null,
        ...
        data.paymentTerm ? [t("shipments.shipmentCard.paymentTerm", "Payment term"), data.paymentTerm] : null,
        data.allowPartialLoad != null
            ...
            : null,
        data.bargain ? [t("shipments.shipmentCard.bargain", "Bargaining"), data.bargain] : null,
