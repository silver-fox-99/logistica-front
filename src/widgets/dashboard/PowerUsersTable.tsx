import {
    Card, CardHeader, CardContent, Table, TableHead, TableRow, TableCell, TableBody, Avatar, Stack, Typography,
} from "@mui/material";
        ...
        >
            ...
            <CardContent sx={{ pt: 0, overflowX: "auto" }}>
                <Table size="medium">
                    ...
                    <TableBody>
                        {rows.map((u) => {
                            const name = [u.first_name, u.last_name].filter(Boolean).join(" ") || u.user_id;
                                ...
                                >
                                    <TableCell sx={{ py: 1.5 }}>
                                        <Stack direction="row" spacing={1.5} alignItems="center">
                                            <Avatar sx={{ width: 32, height: 32, bgcolor: "primary.light", color: "primary.contrastText", fontWeight: 700, fontSize: "14px" }}>
                                                {initials}
                                            </Avatar>
                                    ...
                                    <TableCell align="right" sx={{ fontWeight: 700 }}>{u.ads}</TableCell>
                                </TableRow>
                            );
                        })}
                        {rows.length === 0 && (
