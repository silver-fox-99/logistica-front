    ...
    >
      <Box sx={{ maxWidth: 1200, mx: "auto", px: 3 }}>
        ...
        >
          ...
          >
            YOL — платформа, которая соединяет заказчиков и перевозчиков,
            обеспечивая прямое взаимодействие и прозрачность сделок. Мы создаем
            систему, которая делает перевозку грузов проще и эффективнее для
            всех участников
            {/* {t("homePage.interactiveSectionSubtitle", "Мы разработали инновационные сервисы, которые помогают экономить время и деньги на каждом этапе доставки")} */}
          </Typography>
        </Stack>
