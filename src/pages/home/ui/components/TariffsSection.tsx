  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: 1200, mx: "auto", px: 3 }}>
        <Stack
          spacing={2}
          sx={{ textAlign: "center", alignItems: "center", mb: 5 }}
        >
          ...
          >
            {t(
              "homePage.tariffsMainSubtitle",
              "Выберите подходящий тариф для масштабирования вашего логистического бизнеса. Перевозка ваших грузов по всей стране.",
            )}
          </Typography>
          ...
          >
            {plans.map((plan) => {
              ...
              const isPopular =
                ...
                plan.code.toLowerCase().includes("popular") ||
                plan.priority === 2;
              ...
              if (
                ...
                billingText = ` / ${t("homePage.tariffsPeriodYear", "год")}`;
              } else if (!isFree) {
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4 }} key={plan.id}>
                  <Paper
                    ...
                    sx={{
                      ...
                      boxShadow: isPopular
                        ? "0 10px 30px -10px rgba(15, 95, 194, 0.12)"
                        : "none",
                      ...
                      <Stack spacing={1.5} sx={{ py: 2 }}>
                        ...
                        >
                          ...
                          >
                            {plan.cargo_limit === null
                              ? t(
                                  "homePage.tariffsCargoUnlimited",
                                  "Безлимитно грузов",
                                )
                              : t("homePage.tariffsCargoLimit", {
                                  count: plan.cargo_limit,
                                  defaultValue: `Лимит грузов: ${plan.cargo_limit}`,
                                })}
                          </Typography>
                        </Stack>
                        ...
                        >
                          ...
                          >
                            {plan.vehicle_limit === null
                              ? t(
                                  "homePage.tariffsVehicleUnlimited",
                                  "Безлимитно транспорта",
                                )
                              : t("homePage.tariffsVehicleLimit", {
                                  count: plan.vehicle_limit,
                                  defaultValue: `Лимит транспорта: ${plan.vehicle_limit}`,
                                })}
                          </Typography>
                        </Stack>
                        ...
                        >
                          ...
                          >
                            {plan.order_details_views_per_day_limit === null
                              ? t(
                                  "homePage.tariffsViewDetailsUnlimited",
                                  "Безлимитные контакты",
                                )
                              : t("homePage.tariffsViewDetails", {
                                  count: plan.order_details_views_per_day_limit,
                                  defaultValue: `Контакты: ${plan.order_details_views_per_day_limit}/день`,
                                })}
                          </Typography>
                        </Stack>
                        ...
                        {plan.can_auto_bump && (
                          ...
                          >
                            ...
                            >
                              {t(
                                "homePage.tariffsAutoBump",
                                "Автоподъем объявлений",
                              )}
                            </Typography>
                          </Stack>
                        )}
