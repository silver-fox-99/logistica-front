                ...
                <Grid container spacing={6} alignItems="center">
                    <Grid size={{ xs: 12, md: 7 }}>
                        <Stack spacing={4}>
                            ...
                            >
                                Найдите груз 
и транспорт за несколько минут
                            ...
                            >
                                ...
                                {/* {t("homePage.heroSubtitle", "Сайт для поиска попутных грузов и транспорта для грузоперевозок. Без посредников и переплат.")} */}
                            </Typography>
                                ...
                                {[
                                    ...
                                    <Grid size={{ xs: 6, sm: 3 }} key={i}>
                                        <Stack direction="row" spacing={1.2} alignItems="center">
                                            ...
                                            <Typography variant="body2" sx={{ fontWeight: 600, color: "primary.contrastText", whiteSpace: "nowrap" }}>
                                                {text}
                                            </Typography>
                                        </Stack>
                                    </Grid>
                        ...
                        <Box sx={{ position: "relative", width: "100%", display: "flex", justifyContent: "center" }}>
                            <Box
                                sx={{
                                    ...
                                    height: "110%",
                                    borderRadius: "24px",
                                    background: "radial-gradient(circle, rgba(15,95,194,0.06) 0%, rgba(15,95,194,0) 70%)",
                                    zIndex: 0,
                                }}
                            />
                        </Box>
