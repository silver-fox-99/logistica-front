    ...
    switch (activeStep) {
      case 0:
        return {
          ...
          subtitle: t("forgotPassword.step1Subtitle"),
        };
      case 1:
        return {
          title: t("forgotPassword.step2Title"),
          subtitle: t("forgotPassword.step2Subtitle", {
            phone: e164 || "your phone",
          }),
        };
      case 2:
        return {
          title: t("forgotPassword.step3Title"),
          subtitle: t("forgotPassword.step3Subtitle"),
        };
      default:
  ...
  return (
    ...
    >
      <Stepper
        ...
        sx={{ mb: 3, "& .MuiStepLabel-label": { display: "none" } }}
      >
        {steps.map((_, i) => (
          <Step key={i}>
            <StepLabel />
      ...
      >
        ...
        {activeStep === 2 && (
          <StepNewPassword onSubmit={() => navigate("/dashboard")} />
        )}
      </Box>
    </Container>
  );
