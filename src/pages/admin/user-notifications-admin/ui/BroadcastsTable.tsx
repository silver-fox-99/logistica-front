      ...
      >
        ...
        >
          <Typography color="text.secondary">
            История рассылок пуста. Создайте свою первую рассылку!
          </Typography>
        </Box>
      </TableContainer>
    );
    ...
    >
      <Table sx={{ minWidth: 650 }}>
        <TableHead sx={{ bgcolor: "grey.50" }}>
          <TableRow>
            <TableCell sx={{ fontWeight: 600, width: "160px" }}>Дата</TableCell>
            <TableCell sx={{ fontWeight: 600, width: "180px" }}>Тип</TableCell>
            <TableCell sx={{ fontWeight: 600, width: "220px" }}>
              Заголовок
            </TableCell>
            ...
            <TableCell sx={{ fontWeight: 600, width: "160px" }}>
              Метаданные (JSON)
            </TableCell>
          </TableRow>
        </TableHead>
