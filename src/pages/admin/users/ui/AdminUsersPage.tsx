...
function NameCell({ user, onNavigate }: NameCellProps) {
    ...
    return (
        ...
        >
            <Avatar src={user.avatar ?? undefined} alt={name} sx={{ width: 28, height: 28 }} />
            <Stack spacing={0}>
...
export default function AdminUsersPage() {
    ...
    const dirSafe = params.dir === "asc" || params.dir === "desc" ? params.dir : "desc";
                        ...
                        <TableBody>
                            {items.map((u) => (
                                <TableRow key={u.id} hover>
                                    ...
                                    <TableCell>
                                        <NameCell user={u} onNavigate={() => navigate(`/admin/user/${u.id}`)} />
                                    </TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell>
                                        <Chip size="small" variant="outlined" label={u.registration_stage} />
                                    </TableCell>
