    ...
    return (
        ...
        >
            <DialogTitle sx={{ m: 0, p: 2, display: 'flex', alignItems: 'center', gap: 1.5 }}>
                ...
                <Typography variant="h6" fontWeight={700} component="div" sx={{ flexGrow: 1 }}>
            ...
            <DialogContent sx={{ px: 2.5, py: 1 }}>
                <Typography id="payment-warning-dialog-description" variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                    {t("paymentsNew.cardBindingTip", "💡 Хотите оплатить без привязки карты? В окне платежной системы выберите любой альтернативный метод оплаты вместо сохранения карты.")}
                </Typography>
            </DialogContent>
