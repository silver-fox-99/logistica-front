    ...
    <Stack spacing={3}>
      ...
      >
        ...
        >
          <Tab
            value="active"
            label={t("companyTeam.tabs.active", { count: activeCount })}
          />
          <Tab
            value="history"
            label={t("companyTeam.tabs.history", { count: historyCount })}
          />
          <Tab
            value="invitations"
            label={t("companyTeam.tabs.invitations", {
              count: invitationsCount,
            })}
          />
          <Tab
            value="requests"
            label={t("companyTeam.tabs.requests", { count: requestsCount })}
          />
        </Tabs>
      </Paper>
