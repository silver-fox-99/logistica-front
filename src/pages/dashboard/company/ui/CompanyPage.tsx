...
import { FiArrowRight, FiBriefcase, FiGlobe, FiMapPin, FiPhone, FiPlus, FiSearch } from "react-icons/fi";
            ...
            {current.isLoading ? (
                ...
                <Stack spacing={1.5}>
                    {items.map((company) => {
                        ...
                        const location =
                            [company.country, company.region, company.city].filter(Boolean).join(", ") ||
                            t("companyPage.card.noLocation");
                                    ...
                                    <Stack spacing={1.25} sx={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <Stack spacing={1}>
                                            <InfoRow
                                                ...
                                                value={company.legalName || t("companyPage.card.notSpecified")}
                                            />
                                            <InfoRow
                                                icon={<FiMapPin />}
