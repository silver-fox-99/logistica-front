...
function PlaceRow({
                      ...
                      errorKey, showRemove, onRemove, onCountryLoad, onRegionLoad
                  }: PlaceRowProps) {
    ...
    return (
        <Stack spacing={1.25}>
            <Autocomplete
                ...
                noOptionsText={loadingCountries ? "Загрузка..." : (countries.length > 0 ? (t('addTransport.fields.noOptions') || "Нет вариантов") : "Данные не загружены")}
