...
export default function TenderBidsPage() {
  ...
  const submitBid = async () => {
    ...
    try {
      ...
      toast.error(
        error?.response?.data?.message || t("tenders.bids.saveError"),
      );
    } finally {
      setBusy(false);
    }
  ...
  const selectWinner = async (bidId: string) => {
    ...
    try {
      ...
      toast.error(
        error?.response?.data?.message || t("tenders.bids.winnerError"),
      );
    } finally {
      setSelectingId("");
    }
  ...
  const confirmCode = async () => {
    ...
    try {
      ...
      toast.error(
        error?.response?.data?.message || t("tenders.settings.toast.codeError"),
      );
    } finally {
