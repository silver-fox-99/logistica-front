...
const statusMap: Record<Company["status"], { label: string; color: "default" | "success" | "warning" | "error" }> = {
                    ...
                    <Stack direction="row" spacing={2} alignItems="center">
                        <Stack direction="row" spacing={1} alignItems="center">
                            ...
                            <Typography variant="body2" color="text.secondary">
                                {company.members_limit == null ? "No member limit" : `Member limit: ${company.members_limit}`}
                            </Typography>
                        </Stack>
                    </Stack>
