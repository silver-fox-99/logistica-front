...
export function ShipmentDetailsLimitModal({ open, onClose }: Props) {
        ...
        <Stack spacing={2.5} alignItems="center" textAlign="center">
          ...
          <Stack spacing={1} alignItems="center" sx={{ maxWidth: 480 }}>
            <Typography variant="h5" fontWeight={800}>
              {t("shipments.orderDetailsLimit.title")}
            </Typography>

            <Typography variant="body2" color="text.secondary">
              {t("shipments.orderDetailsLimit.description")}
            </Typography>
          </Stack>
          ...
          >
            {t("shipments.orderDetailsLimit.goToPayments")}
          </Button>
        </Stack>
      </DialogContent>
    </Dialog>
